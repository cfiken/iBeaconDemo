...
SWIFT_CLASS("_TtC11iBeaconDemo11AppDelegate")
...
SWIFT_CLASS("_TtC11iBeaconDemo14ViewController")
@interface ViewController : UIViewController <CLLocationManagerDelegate>
@property (nonatomic) IBOutlet UILabel * __null_unspecified status;
@property (nonatomic) IBOutlet UILabel * __null_unspecified uuid;
@property (nonatomic) IBOutlet UILabel * __null_unspecified major;
@property (nonatomic) IBOutlet UILabel * __null_unspecified minor;
@property (nonatomic) IBOutlet UILabel * __null_unspecified accuracy;
@property (nonatomic) IBOutlet UILabel * __null_unspecified rssi;
@property (nonatomic) IBOutlet UILabel * __null_unspecified distance;
@property (nonatomic, readonly) NSUUID * __nullable proximityUUID;
@property (nonatomic) CLBeaconRegion * __nonnull region;
@property (nonatomic) CLLocationManager * __nonnull manager;
- (void)viewDidLoad;
- (void)locationManager:(CLLocationManager * __nonnull)manager didStartMonitoringForRegion:(CLRegion * __nonnull)region;
- (void)locationManager:(CLLocationManager * __nonnull)manager didDetermineState:(CLRegionState)state forRegion:(CLRegion * __nonnull)inRegion;
